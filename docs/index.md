...
configured properly, it can be chatty. After all, it's a penguin :penguin:
...
Do you want to know all the tips and tricks on how to use it? Head down to the [Usage guide](user/index.md), where you
can find all the available commands and how to use them!
...
!!! warning "Patrizio is in early development"
    ...
    errors. Sometimes, these are hard to spot. If you find one that hasn't been reported, please open an issue in
    [Patrizio's issue tracker](https://github.com/Polpetta/patrizio-bot/issues). Each small
