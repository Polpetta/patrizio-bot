...
The project SHALL include a Dockerfile with a multi-stage build: a `golang:1.24` builder stage and a `gcr.io/distroless/static-debian12` runtime stage.

#### Scenario: Docker image builds successfully
- **WHEN** a developer runs `make docker-build`
- **THEN** Docker produces a runnable image containing only the static Patrizio binary
